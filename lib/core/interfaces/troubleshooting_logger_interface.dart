...
abstract class ITroubleshootingLogger {
  ...
  /// Log a warning
  Future<void> warning(String message, {String? tag, Object? error, Map<String, dynamic>? metadata});

  /// Log an error
  Future<void> error(String message, {String? tag, Object? error, StackTrace? stackTrace, Map<String, dynamic>? metadata});

  /// Log a critical error
  Future<void> critical(String message, {String? tag, Object? error, StackTrace? stackTrace, Map<String, dynamic>? metadata});
